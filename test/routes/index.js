...
module.exports = {
  ...
  notasUsuario({ body }, res) {
    const children = fork(__dirname + '/../controllers/notas_usuario.js')
    children.send(body)
  ...
  // * Usuarios
  usuarios({ body }, res) {
    const children = fork(__dirname + '/../controllers/usuarios.js')
    children.send(body)
  ...
  // * Visitas
  visitas({ body }, res) {
    const children = fork(__dirname + '/../controllers/visitas.js')
    children.send(body)
  ...
  // * Reinicios
  reinicios({ body }, res) {
    const children = fork(__dirname + '/../controllers/reinicios.js')
    children.send(body)
  ...
  evaluacionesAbiertas({ body }, res) {
    const children = fork(__dirname + '/../controllers/eva_abiertas.js')
    children.send(body)
  ...
  consolidadoTemas({ body }, res) {
    const children = fork(__dirname + '/../controllers/consolidado_temas_v2.js')
    children.send(body)
  ...
  consolidadoCursos({ body }, res) {
    const children = fork(__dirname + '/../controllers/consolidado_cursos_v2.js')
    children.send(body)
